ccNetViz = function(canvas, options) {
    ...
    this.set = function(nodes, edges, layout) {
        ...
        scene.nodes.set(gl, options.styles, textures, nodes, style => ({
            set: (v, e, iV, iI) => {
                var x = e.x;
                var y = e.y;
        ...
        scene.edges.set(gl, options.styles, textures, edges, style => ({
            set: (v, e, iV, iI) => {
                var s = e.source;
                var t = e.target;
                var d = normalize(s, t);
        ...
        edgeStyle.arrow && scene.arrows.set(gl, options.styles, textures, edges, style => ({
            set: (v, e, iV, iI) => {
                var s = e.source;
                var t = e.target;
                var d = normalize(s, t);
    ...
    this.draw = () => {
        window.requestAnimationFrame(() => {
            ...
            scene.elements.forEach(e => e.draw(context, transform));
        });
    }
